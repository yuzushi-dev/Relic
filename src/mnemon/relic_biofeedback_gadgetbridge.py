#!/usr/bin/env python3
"""Gadgetbridge SQLite export parser - ingests biofeedback into relic.db.
...
Usage:
  python3 relic_biofeedback_gadgetbridge.py --db /path/to/Gadgetbridge.db
  python3 relic_biofeedback_gadgetbridge.py --db /path/to/Gadgetbridge.db --date 2026-03-24
  python3 relic_biofeedback_gadgetbridge.py --db /path/to/Gadgetbridge.db --dry-run
"""
...
from relic_biofeedback import derive_observations, get_db, store_all

from lib.log import info, warn

SCRIPT = "relic_biofeedback_gb"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Ingest Gadgetbridge export into relic biofeedback"
    )
