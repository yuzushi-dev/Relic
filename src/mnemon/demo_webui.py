"""Static demo console for the public Relic OSS flow."""
...
<head>
  ...
  <title>Relic · Secure Your Soul · Arasaka Corp</title>
    ...
    <main class="content">
        ...
        <div class="hero-grid">
          <div>
            ...
            <div class="lede">
              ...
              This view is isolated from the private Relic runtime - no live databases, schedulers, or personal logs are accessed. The soul map below is entirely synthetic.
            </div>
      ...
      <section class="grid">
        ...
        <article class="card span-12">
          ...
          <div class="footer">荒坂 CORP · RELIC · SECURE YOUR SOUL · Engrammatic transfer demo - no live runtime. Unauthorized access is a capital offense.</div>
        </article>
      </section>
    </main>
  </div>
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build the static Relic demo console.")
    parser.add_argument(
        "--output-dir",
        type=Path,
