#!/usr/bin/env python3
"""Relic Entity & Episode Extractor
...
Cron: relic:entity-extract, daily 04:00 Europe/Rome

State file: relic/entity-extractor-state.json
