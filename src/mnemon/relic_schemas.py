#!/usr/bin/env python3
"""Relic Schema Detector - Early Maladaptive Schemas (Young 1990).

Analizza il corpus inbox per rilevare i 18 schemi di Young.

Cron: relic:schemas, monthly 1° del mese 05:00 Europe/Rome

Usage:
  python3 relic_schemas.py [--model ...] [--dry-run] [--sample N]
"""
...
def main() -> int:
    import argparse
    p = argparse.ArgumentParser(description="Relic Schema Detector")
