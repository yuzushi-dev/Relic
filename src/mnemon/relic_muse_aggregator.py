#!/usr/bin/env python3
"""Relic Muse 2 EEG Aggregator - Sprint 3.

Reads completed EEG sessions from the DB (stored by relic_muse_recorder),
...
Cron: relic:muse-aggregate, daily 04:30 Europe/Rome

Usage:
  python3 relic_muse_aggregator.py [--date YYYY-MM-DD] [--dry-run]
"""
...
from relic_muse_recorder import EEG_SCHEMA_SQL
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Relic Muse 2 EEG Aggregator")
