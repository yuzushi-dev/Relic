#!/usr/bin/env python3
"""Relic LIWC - Analisi psicolinguistica sul corpus inbox.
...
Cron: relic:liwc, settimanale domenica 03:00 Europe/Rome

Usage:
  python3 relic_liwc.py [--period YYYY-WW] [--all] [--dry-run]
"""
...
def main() -> int:
    import argparse
    p = argparse.ArgumentParser(description="Relic LIWC Psycholinguistics")
