...
State: relic/decisions-state.json
  {"last_processed_inbox_id": 0}

Cron: relic:decisions, daily 04:15 Europe/Rome

Usage:
  python3 relic_decisions.py [--model ...] [--dry-run] [--backfill]
"""
...
def main() -> int:
    import argparse
    parser = argparse.ArgumentParser(description="Relic Decision Extractor")
