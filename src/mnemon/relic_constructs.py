#!/usr/bin/env python3
"""Relic Personal Constructs - Kelly's Repertory Grid Framework.
...
Cron: relic:constructs, monthly 5th 06:00 Europe/Rome

Usage:
  python3 relic_constructs.py [--model ...] [--dry-run] [--sample N]
"""
...
from relic_run_guard import should_skip, mark_ran

SCRIPT = "relic_constructs"
...
def main() -> int:
    import argparse
    p = argparse.ArgumentParser(description="Relic Personal Constructs Analyzer")
