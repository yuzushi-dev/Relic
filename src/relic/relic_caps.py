#!/usr/bin/env python3
"""Relic CAPS - Situation-Behavior Signatures (Mischel & Shoda 1995).
...
Cron: relic:caps, monthly 2° del mese 05:30 Europe/Rome

Usage:
  python3 relic_caps.py [--model ...] [--dry-run] [--sample N]
"""
...
def main() -> int:
    import argparse
    p = argparse.ArgumentParser(description="Relic CAPS Signatures")
