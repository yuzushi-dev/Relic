#!/usr/bin/env python3
"""Relic Muse 2 EEG Recorder - Sprint 2.
...
Usage:
  python3 relic_muse_recorder.py --context coding [--note "...]
  python3 relic_muse_recorder.py --list-sessions
"""
...
class MuseRecorder:
    """Records a single EEG session to the relic SQLite DB.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Relic Muse 2 EEG Recorder")
