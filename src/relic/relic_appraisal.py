#!/usr/bin/env python3
"""Relic Appraisal Theory Profiler - Lazarus/Scherer Framework.
...
Cron: relic:appraisal, monthly 5th 04:30 Europe/Rome

Usage:
  python3 relic_appraisal.py [--model ...] [--dry-run] [--sample N]
"""
...
def main() -> int:
    import argparse
    p = argparse.ArgumentParser(description="Relic Appraisal Theory Profiler")
