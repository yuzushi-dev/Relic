#!/usr/bin/env python3
"""Relic Daily Stress - Indice composito giornaliero di stress.
...
Cron: relic:daily-stress, daily 06:30 Europe/Rome (dopo biofeedback pull 04:05)

Usage:
  python3 relic_daily_stress.py [--date YYYY-MM-DD] [--dry-run]
"""
...
def main() -> int:
    p = argparse.ArgumentParser(description="Relic Daily Stress Index")
