#!/usr/bin/env python3
"""Relic Mental Models - Johnson-Laird Framework.
...
Cron: relic:mental-models, monthly 5th 05:00 Europe/Rome

Usage:
  python3 relic_mental_models.py [--model ...] [--dry-run] [--sample N]
"""
...
def main() -> int:
    import argparse
    p = argparse.ArgumentParser(description="Relic Mental Models Analyzer")
