#!/usr/bin/env python3
"""Relic SDT - Self-Determination Theory Need Satisfaction.

Traccia autonomy/competence/relatedness satisfaction per dominio
(lavoro, relazioni, personale) da inbox recente.

Cron: relic:sdt, monthly 1° del mese 06:00 Europe/Rome

Usage:
  python3 relic_sdt.py [--model ...] [--period YYYY-MM] [--dry-run]
"""
...
def main() -> int:
    import argparse
    p = argparse.ArgumentParser(description="Relic SDT Need Satisfaction")
