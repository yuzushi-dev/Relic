#!/usr/bin/env python3
"""Relic Idiolect Model - Linguistic fingerprint profiling.
...
Cron: relic:idiolect, monthly 1st 04:00 Europe/Rome

Usage:
  python3 relic_idiolect.py [--period YYYY-MM] [--all] [--dry-run]
"""
...
def main() -> int:
    import argparse
    p = argparse.ArgumentParser(description="Relic Idiolect Model")
