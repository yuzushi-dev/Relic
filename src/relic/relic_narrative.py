#!/usr/bin/env python3
"""Relic Narrative Identity - McAdams narrative structure analysis.
...
Cron: relic:narrative, monthly 3° del mese 06:00 Europe/Rome

Usage:
  python3 relic_narrative.py [--model ...] [--dry-run]
"""
...
def main() -> int:
    import argparse
    p = argparse.ArgumentParser(description="Relic Narrative Identity")
