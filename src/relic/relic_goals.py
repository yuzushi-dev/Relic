#!/usr/bin/env python3
"""Relic Goals - Estrae gerarchia goal e conflitti da inbox + decisioni.

Cron: relic:goals, monthly 1° del mese 05:30 Europe/Rome

Usage:
  python3 relic_goals.py [--model ...] [--dry-run] [--sample N]
"""
...
def main() -> int:
    import argparse
    p = argparse.ArgumentParser(description="Relic Goals Extractor")
