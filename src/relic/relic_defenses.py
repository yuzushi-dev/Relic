#!/usr/bin/env python3
"""Relic Defense Mechanism Detector - Vaillant Hierarchy.
...
Cron: relic:defenses, monthly 3° del mese 05:30 Europe/Rome

Usage:
  python3 relic_defenses.py [--model ...] [--dry-run] [--sample N]
"""
...
def main() -> int:
    import argparse
    p = argparse.ArgumentParser(description="Relic Defense Mechanism Detector")
