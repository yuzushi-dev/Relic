#!/usr/bin/env python3
"""Relic Domain-Aware Probing Scheduler (IMP-16)
...
Cron: relic:domain-prober, biweekly Wednesday 10:00 Europe/Rome
...
Usage:
  python3 relic_domain_prober.py [--dry-run] [--model ...]
"""
...
def main() -> int:
    import argparse
    p = argparse.ArgumentParser(description="Relic Domain-Aware Probing Scheduler")
