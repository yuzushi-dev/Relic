...
Injects the current Relic personality model into every agent session's
...
- Reads `workspace/relic/PORTRAIT.md` (full personality model)
...
- Skips sub-agent sessions and relic-internal sessions to avoid context bloat
