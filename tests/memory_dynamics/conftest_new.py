"""Pytest configuration for new memory dynamics tests."""
...
from relic.memory_dynamics import MemoryDynamicsService
from relic.persistence import MemoryPersistence


@pytest.fixture
def memory_dynamics_service(tmp_path: Path) -> Generator[MemoryDynamicsService, None, None]:
    """Provide a MemoryDynamicsService instance for testing."""
    persistence = MemoryPersistence(trace_path=tmp_path / "trace.jsonl")
    service = MemoryDynamicsService(persistence)
    yield service
