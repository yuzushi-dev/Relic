...
PROJECT_ITEMS = [
    ...
    _item("PRO_008", "proactivity_permissions", "Gumi may send messages late in the evening.", "Gumi puo inviare messaggi la sera tardi.", "frequency_permission_4", "late_night_permission", "project_derived_safety_gate", "Relic/Gumi safety gate", PROJECT_CITATION),
