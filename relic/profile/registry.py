...
"""
    ...
    def _cron_prompt_for_job(self, job: dict[str, Any]) -> str:
        ...
        if task == "gumi_checkin_message":
            return (
                "Sei Gumi. Il gate mostra DELIVER con tipo, ora, e a volte un flag ask con un topic. "
                ...
                "Una domanda sola. Niente preamboli tipo 'posso chiederti una cosa?'.\n"
                "Se non vedi 'ask: true', NON fare domande — concentrati su un breve aggancio o follow-up.\n"
                "\n"
                "Modalità:\n"
                "\n"
                "tipo: text\n"
                "Max 2 frasi, italiano, tono tuo. Se ask: true, la domanda può occupare la seconda frase.\n"
                "\n"
                "tipo: voice\n"
                ...
                "senza punteggiatura finale tranne virgole. Se ask: true, la domanda va nella caption.\n"
